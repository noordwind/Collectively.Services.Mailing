...
|Branch             |Build status                                                  
|-------------------|-----------------------------------------------------
|master             |[![master branch build status](https://api.travis-ci.org/noordwind/Coolector.Services.Mailing.svg?branch=master)](https://travis-ci.org/noordwind/Coolector.Services.Mailing)
|develop            |[![develop branch build status](https://api.travis-ci.org/noordwind/Coolector.Services.Mailing.svg?branch=develop)](https://travis-ci.org/noordwind/Coolector.Services.Mailing/branches)
